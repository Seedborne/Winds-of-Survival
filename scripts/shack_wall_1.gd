...
@export var upgrade_levels = [
	{"level": "broken", "next": "wood", "cost": {"wood": 3}, "sprite": "res://assets/brokenwall1.png"},
	{"level": "wood", "next": "stone", "cost": {"stone": 3}, "sprite": "res://assets/wall1wood.png"},
	{"level": "stone", "next": "metal", "cost": {"metal": 3}, "sprite": "res://assets/stonewall1.png"},
...
func _ready():
	current_level_index = Globals.wall1_index
	update_sprite()
...
func deduct_resources():
	...
	Globals.wall1_index += 1
	if current_level_index == 1:
		Globals.shack_strength += 5
		$Wall1Label.text = "Upgrade wall 
		for 3 stone"
