...
func get_random_spawn_position() -> Vector2:
	...
	return Vector2(
		randf_range(spawn_area.position.x - rect_shape.extents.x, spawn_area.position.x + rect_shape.extents.x),
		randf_range(spawn_area.position.y - rect_shape.extents.y, spawn_area.position.y + rect_shape.extents.y)
	)
