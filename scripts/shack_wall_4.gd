...
@export var upgrade_levels = [
	{"level": "broken", "next": "wood", "cost": {"wood": 3}, "sprite": "res://assets/Indoorbrokenwall1.png"},
	{"level": "wood", "next": "stone", "cost": {"stone": 3}, "sprite": "res://assets/indoorwoodwall1.png"},
	{"level": "stone", "next": "metal", "cost": {"metal": 3}, "sprite": "res://assets/indoorstonewall1.png"},
	{"level": "metal", "next": "", "cost": null, "sprite": "res://assets/metalindoorwall1.png"}
]
...
func _ready():
	current_level_index = Globals.wall4_index
	update_sprite()
...
func deduct_resources():
	...
	Globals.wall4_index += 1
	if current_level_index == 1:
		Globals.shack_strength += 5
		$Wall4Label.text = "Upgrade wall 
		for 3 stone"
...
func _on_wall_4_area_2d_body_entered(body: Node) -> void:
	if body is Player:
		player_in_area = true
		$Wall4Dot.hide()
		if current_level_index < upgrade_levels.size() - 1:
...
func _on_wall_4_area_2d_body_exited(body: Node) -> void:
	if body is Player:
