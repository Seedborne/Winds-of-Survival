...
@export var upgrade_levels = [
	{"level": "broken", "next": "wood", "cost": {"wood": 3}, "sprite": "res://assets/indoorbrokenwall2.png"},
	{"level": "wood", "next": "stone", "cost": {"stone": 3}, "sprite": "res://assets/Indoorwoodwall2.png"},
	{"level": "stone", "next": "metal", "cost": {"metal": 3}, "sprite": "res://assets/indoorstonewall2.png"},
	{"level": "metal", "next": "", "cost": null, "sprite": "res://assets/metalinsidewindow.png"}
]
...
func _ready():
	current_level_index = Globals.wall3_index
	update_sprite()
...
func deduct_resources():
	...
	Globals.wall3_index += 1
	if current_level_index == 1:
		Globals.shack_strength += 5
		$Wall3Label.text = "Upgrade wall 
		for 3 stone"
...
func _on_wall_3_area_2d_body_entered(body: Node) -> void:
	if body is Player:
		player_in_area = true
		$Wall3Dot.hide()
		if current_level_index < upgrade_levels.size() - 1:
...
func _on_wall_3_area_2d_body_exited(body: Node) -> void:
	if body is Player:
